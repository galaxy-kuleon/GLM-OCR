...
- [ ] Step 0: WORKSPACE=___ TARGET_LANG=___
- [ ] Step 1: Source data read, PAGE_COUNT=___
- [ ] Step 2.1: Text extracted, segments=___
- [ ] Step 2.2: Translation complete
- [ ] Step 2.3: Translated XML written
- [ ] Step 3: translated-output.docx size=___ bytes
